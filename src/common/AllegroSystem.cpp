...
AllegroSystem::AllegroSystem() { allegro_init(); }
...
bool AllegroSystem::setupScreen(const ObjectSize &size, bool fullScreen,
...
void AllegroSystem::TimeTicker() { AllegroSystem::TimeTicks++; }
